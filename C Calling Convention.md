...
```asm
(gdb) x/100x $rsp
0x7fffffffdc30: 0xffffdc80      0x00007fff      0x004008f8      0x00000000 //1. 当前RBP is here(0x7fffffffdc30), 调用函数(func2)RBP is 0x7fffffffdc80. 返回地址()
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwNDc5Mzg1NywxMjc4MDIyNjUsLTk5Nz
