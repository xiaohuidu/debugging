...
```asm
(gdb) x/100x $rsp
0x7fffffffdc30: 0xffffdc80      0x00007fff      0x004008f8      0x00000000 //1. 当前RBP is here(0x7fffffffdc30), old RBP is 0x7fffffffdc80. 上一个
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODE4MTE5ODQsMTI3ODAyMjY1LC05OT
