...
0x0000000000400903 <+4>:        48 83 ec 10     sub    $0x10,%rsp // 移动栈顶寄存器(Stack Pointer)用来放局部变量(int a, char*str). 为什么是16 而不是12? 原因是stack alignment： stack 应该以16 byte 对齐。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODg1NTM5MzQ3LC0zNjI3NjY4NTIsMTc2Nj
